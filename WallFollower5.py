#!/usr/bin/env python3
"""
Wall Follower with Obstacle Avoidance
- Follows the nearest wall at a constant setpoint distance
- Moves tangentially along the wall
- Detects obstacles in front and navigates around them
- Returns to wall following after clearing obstacles
"""
...
SETPOINT   = 0.30   # target distance to wall (m) - closer to wall
KP         = 1.5    # P-gain for wall distance correction - more aggressive
DEADBAND   = 0.02   # m around setpoint (no correction zone) - tighter tolerance
